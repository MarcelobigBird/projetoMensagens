...
let modalTitle = document.querySelector('.modal-wrapper .modal h2');
let modalParagraph = document.querySelector('.modal-wrapper .modal p');
let modalButton = document.querySelector('.modal .buttons button.red');
